...
class Stock extends React.Component {
  ...
  loadOptions = async (inputText, callBack) => {
    const API_KEY = 'GRZKHQQAODJHTIG3';
     ...
     * https://www.alphavantage.co/query?function=SYMBOL_SEARCH&keywords=ACN&apikey=GRZKHQQAODJHTIG3
     */
    let arr = [];
  ...
  fetchStock = async (StockSymbol) => {
    ...
    const API_KEY = 'YLV9TKFRJ670BU9D';
    ...
    /*
     * Use the following url to view the output of the response
     * https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=AAPL&outputsize=compact&apikey=YLV9TKFRJ670BU9D
     */
