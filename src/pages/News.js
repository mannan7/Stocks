...
export default class News extends React.Component {
    ...
    fetchNews = async (query) => {
        ...
        let url = 'https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=6eb6708577c746cbb2da65d60c2e1e3b' 
        // `q=${query}&` +
        // `from=${Date.now()}&` +
        // `to=${date}&`+
        // 'sortBy=popularity&' +
        // 'country=in&'+
        // 'category=business&'+
        // 'apiKey=6eb6708577c746cbb2da65d60c2e1e3b';
